...
def load_model_and_tokenizer():
    """
    Handles authentication and loads the Phi-4 model in 16-bit precision (bfloat16).
    """
...
def parse_single_response(response_text):
    ...
    if response_text.strip().startswith("<think>"):
        print(f"Warning: Model generated a reasoning tag. Defaulting to 0. Response: '{response_text}'")
        reasoning = "Model generated an invalid reasoning tag."
        return 0, reasoning
